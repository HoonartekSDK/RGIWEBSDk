(function($){
	...
	customTemplate.prototype.renderMessage = function (msgData) {
		...
		// hoonartek customization for floating Button Template selection starts start
		else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "floatingButtonTemplate") {
			messageHtml = $(this.getChatTemplate("floatingButtonTemplate")).tmpl({
				'msgData': msgData,
				'helpers': this.helpers,
				'extension': this.extension
...
//hoonartek customization for health box

// var message = {
// 	"type": "template",
// 	"payload": {
// 	  "template_type": "insuranceTemplate",
// 	  "totalPrice": "5404",  // Total price to be displayed at the bottom
// 	  "insuranceOptions": [
// 		{
// 		  "id": "enhancedCover",
// 		  "title": "Enhanced Cover",
// 		  "description": "Guaranteed Cumulative Bonus: Choose this to keep your unused cumulative bonus intact...",
// 		  "price": "500",  // Price for this option
// 		  "limitOptions": [
// 			{ "value": "500", "text": "₹500" },
...
// 		  "id": "doubleCover",
// 		  "title": "Double Cover",
// 		  "description": "Get 100% base sum insured over and above to be used on the same claim.",
// 		  "price": "700"
// 		},
// 		{
// 		  "id": "roomRentLimit",
// 		  "title": "Room Rent Limit",
// 		  "description": "Increase/decrease your hospital room rent limits.",
// 		  "price": "600",
// 		  "limitOptions": [
// 			{ "value": "1000", "text": "₹1000" },
...
// 		  "description": "If none of these apply, select this option.",
// 		  "price": "0"
// 		}
// 	  ],
// 	  "buttons": [
...
// 		  "title": "Next",
// 		  "type": "postback",
// 		  "payload": "payload"  // Payload to handle the click event
// 		}
// 	  ]
// 	}
//   };
...
//payload for it
	...
	// country Template Payload
		...
		// var floatingButtonTemplate = '<script id="chat_message_floating_button_tmpl" type="text/x-jquery-tmpl">\
		// 									{{if msgData.message}} \
		// 									<li class="{{if msgData.type === "bot_response"}}fromOtherUsers{{else}}fromCurrentUser{{/if}}"> \
		// 										<div class="floatingButtonWrapper"> \
		// 											<!-- Question Text Above Buttons --> \
		// 											{{if msgData.message[0].component.payload.question}} \
		// 												<div class="floatingButtonQuestion">${msgData.message[0].component.payload.question}</div> \
		// 											{{/if}} \
		// 											<!-- Floating Button Container --> \
		// 											<div class="floatingButtonContainer"> \
		// 												{{each(i, button) msgData.message[0].component.payload.buttons}} \
		// 													<button id="${button.id}" class="floatingButton" titile=${button.title} value="${button.value}">${button.value}</button> \
		// 												{{/each}} \
		// 											</div> \
		// 										</div> \
		// 									</li> \
		...
		// hoonartek customization for travel countries starts start
			...
			console.log('checkBoxesTemplate')
			// Call the reset function initially when the page is loaded or template is rendered			
			return checkBoxesTemplate;
		} 

		// hoonartek customization for floating Button Template starts start
		else if(tempType === "floatingButtonTemplate"){
			console.log("This is the country selection template.");
			
            return floatingButtonTemplate;
		}
		// hoonartek customization for floating Button Template ends
